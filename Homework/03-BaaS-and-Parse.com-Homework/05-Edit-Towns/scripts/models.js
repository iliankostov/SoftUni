...
world.model = (function() {
    ...
    var Town = (function() {
        ...
        Town.prototype.addTown = function addTown(town, success, error) {
            return Request.postRequest(this.serviceUrl, town, success, error);
        };

        Town.prototype.editTown = function editTown(id, town, success, error) {
            return Request.editRequest(this.serviceUrl + id, town, success, error)
        };

        Town.prototype.deleteTown = function deleteTown(id, success, error) {
            return Request.deleteRequest(this.serviceUrl + id, success, error)
        };
