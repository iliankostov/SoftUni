...
public class ShoppingCenterOrderedBag
{
    ...
    private string FindProductsByName(string name)
    {
        ...
        {
            string formattedProducts = this.PrintProducts(productsFound);
    ...
    private string FindProductsByPriceRange(string from, string to)
    {
        ...
        var productGroups = this.productsByPrice.Range(rangeStart, true, rangeEnd, true).Values;
        ...
        {
            products.Sort();
            string formattedProducts = this.PrintProducts(products);
            return formattedProducts;
        }
