...
{
    private static IDictionary<int, int> CalcPossibleSums(int[] nums, int targetSum)
    {
    ...
    private static IEnumerable<int> FindSubset(int[] nums, int targetSum, IDictionary<int, int> possibleSums)
    {
