...
public class KnapsackTests
{
    ...
    {
        var items = new[] { new Item { Weight = 5, Price = 30 } };
    ...
    {
        var items = new[] { new Item { Weight = 5, Price = 30 }, new Item { Weight = 10, Price = 55 } };
    ...
    public void TestKnapsack7ItemsCapacity0()
    {
        var items = new[]
                        {
                            new Item { Weight = 5, Price = 30 }, new Item { Weight = 8, Price = 120 },
                            new Item { Weight = 7, Price = 10 }, new Item { Weight = 0, Price = 20 },
                            new Item { Weight = 4, Price = 50 }, new Item { Weight = 5, Price = 80 },
