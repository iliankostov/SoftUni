namespace RotatingWalkInMatrix
{
    ...
    public static class Matrix
    {
        ...
        private static void FindStartCell(int[,] matrix, out int row, out int col)
        {
            int matrixSize = matrix.GetLength(0);
            row = 0;
            col = 0;
        ...
        private static bool CheckNextMove(int[,] matrix, int row, int col)
        {
            ...
            return directionsX.Where((t, i) => matrix[row + t, col + directionsY[i]] == 0).Any();
        }
