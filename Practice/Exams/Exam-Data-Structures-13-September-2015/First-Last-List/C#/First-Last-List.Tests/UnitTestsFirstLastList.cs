...
public class UnitTestsFirstLastList
{
    ...
    public void Add7ItemsDuplicates_Remove3Items_First3Items()
    {
        ...
        var expectedItems = new[] { "first", "coffee", "candy" };
        CollectionAssert.AreEqual(expectedItems, returnedItems);
    }
    ...
    public void Add7ItemsDuplicates_Remove3Items_Last3Items()
    {
        ...
        // Assert
        Assert.AreEqual(3, countRemoved);
        var expectedItems = new[] { "candy", "chocolate", "coffee" };
        CollectionAssert.AreEqual(expectedItems, returnedItems);
    }
    ...
    public void Add7ItemsDuplicates_Remove3Items_Min3Items()
    {
        ...
        // Assert
        Assert.AreEqual(3, countRemoved);
        var expectedItems = new[] { "cent", "coffee", "candy" };
        CollectionAssert.AreEqual(expectedItems, returnedItems);
    }
    ...
    public void Add7ItemsDuplicates_Remove3Items_Max2Items()
    {
        ...
        // Assert
        Assert.AreEqual(3, countRemoved);
        var expectedItems = new[] { "chocolate", "coffee", "candy" };
        CollectionAssert.AreEqual(expectedItems, returnedItems);
    }
    ...
    public void ComplexTest_AllOperationsProducts()
    {
        ...
        CollectionAssert.AreEqual(new[] { "beer", "vodka" }, first2);
        CollectionAssert.AreEqual(new[] { "candy", "coffee" }, last2);
        CollectionAssert.AreEqual(new[] { "coffee", "candy" }, min2);
        CollectionAssert.AreEqual(new[] { "vodka", "beer" }, max2);
        ...
        CollectionAssert.AreEqual(new[] { "coffee", "candy" }, first2);
        CollectionAssert.AreEqual(new[] { "candy", "coffee" }, last2);
        CollectionAssert.AreEqual(new[] { "coffee", "candy" }, min2);
        CollectionAssert.AreEqual(new[] { "coffee", "candy" }, max2);
        ...
        min2 = items.Min(2).Select(p => p.Title).ToList();
        max2 = items.Max(2).Select(p => p.Title).ToList();
        CollectionAssert.AreEqual(new[] { "milk", "amstel" }, first2);
        CollectionAssert.AreEqual(new[] { "xxx", "amstel" }, last2);
        CollectionAssert.AreEqual(new[] { "milk", "amstel" }, min2);
        CollectionAssert.AreEqual(new[] { "amstel", "xxx" }, max2);
