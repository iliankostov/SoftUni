namespace AutomationTests.Pages.RegistrationPage
{
    ...
    public class RegistrationPageElements
    {
        ...
        public RegistrationPageElements(IWebDriver driver)
        {
            this.driver = driver;
        ...
        public IWebElement ErrorMessagesForNames
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.ERROR_NAME_SELECTOR)));
        ...
        public IWebElement ErrorMessagesForConfirmPassword
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.ERROR_CONFIRM_PASSWORD_SELECTOR)));
