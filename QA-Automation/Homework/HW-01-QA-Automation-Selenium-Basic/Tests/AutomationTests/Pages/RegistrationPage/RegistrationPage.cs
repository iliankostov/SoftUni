namespace AutomationTests.Pages.RegistrationPage
{
    ...
    public class RegistrationPage : BasePage<RegistrationPageElements>
    {
        public RegistrationPage(IWebDriver driver) : base(driver, new RegistrationPageElements(driver))
        {
        }
