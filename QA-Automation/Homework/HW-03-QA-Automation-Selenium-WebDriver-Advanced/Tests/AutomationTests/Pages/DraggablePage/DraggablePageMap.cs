namespace AutomationTests.Pages.DraggablePage
{
    ...
    public class DraggablePageMap
    {
        ...
        public IWebElement BodyElement
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.TagName(Constants.BODY_ELEMENT)));
        ...
        public IWebElement DefaultDragElement
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.DEFAULT_DRAG_ELEMENT)));
        ...
        public IWebElement ConstraintMovementElement
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.CONSTRAINT_MOVEMENT_ELEMENT)));
        ...
        public IWebElement CursorStyleElement
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.CURSOR_STYLE_ELEMENT)));
        ...
        public IWebElement DragEventElement
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.DRAG_EVENT_ELEMENT)));
        ...
        public IWebElement EventStartElement
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.EVENT_START_ELEMENT)));
        ...
        public IWebElement EventDragElement
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.EVENT_DRAG_ELEMENT)));
        ...
        public IWebElement EventStopElement
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.EVENT_STOP_ELEMENT)));
        ...
        public IWebElement DraggableBoxElement
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.DRAGGABLE_BOX_ELEMENT)));
        ...
        public IWebElement DragMeDownElement
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.DRAG_ME_DOWN_ELEMENT)));
