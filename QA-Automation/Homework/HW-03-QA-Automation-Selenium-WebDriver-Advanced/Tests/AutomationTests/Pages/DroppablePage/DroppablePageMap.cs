namespace AutomationTests.Pages.DroppablePage
{
    ...
    public class DroppablePageMap
    {
        ...
        public IWebElement DraggableView
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.DRAGGABLE_VIEW_SELECTOR)));
        ...
        public IWebElement DroppableView
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.DROPPABLE_VIEW_SELECTOR)));
        ...
        public IWebElement DraggableNonVaid
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.DRAGGABLE_NON_VALID_SELECTOR)));
        ...
        public IWebElement DroppableAccept
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.DROPPABLE_ACCEPT_SELECTOR)));
        ...
        public IWebElement DraggableProp
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.DRAGGABLE_PROP_SELECTOR)));
        ...
        public IWebElement InnerDroppableGreedy
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.INNER_DROPPABLE_GREEDY_SELECTOR)));
        ...
        public IWebElement OuterDroppable
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.OUTER_DROPPABLE_SELECTOR)));
        ...
        public IWebElement DraggableRevert
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.DRAGGABLE_REVERT_SELECTOR)));
        ...
        public IWebElement DroppableRevert
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.DROPPABLE_REVERT_SELECTOR)));
        ...
        public IWebElement Product
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.PRODUCT_SELECTOR)));
        ...
        public IWebElement ShoppingCart
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.SHOPPING_CART_SELECTOR)));
