namespace AutomationTests.Pages.ResizablePage
{
    ...
    public class ResizablePageMap
    {
        ...
        public IWebElement DefaultResizableBox
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.DEFAULT_RESIZABLE_BOX)));
        ...
        public IWebElement DefaultResizeAngle
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.DEFAULT_RESIZE_ANGLE)));
        ...
        public IWebElement ConstraintResizableBox
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.CONSTRAINT_RESIZABLE_BOX)));
        ...
        public IWebElement ConstraintResizeAngle
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.CONSTRAINT_RESIZE_ANGLE)));
        ...
        public IWebElement MinMaxResizableBox
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.MIN_MAX_RESIZABLE_BOX)));
        ...
        public IWebElement MinMaxResizeAngle
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.XPath(Constants.MIN_MAX_RESIZE_ANGLE)));
