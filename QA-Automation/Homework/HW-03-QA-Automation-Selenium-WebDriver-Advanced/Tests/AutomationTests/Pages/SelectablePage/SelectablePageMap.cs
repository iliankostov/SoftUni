namespace AutomationTests.Pages.SelectablePage
{
    ...
    public class SelectablePageMap
    {
        ...
        public IList<IWebElement> SelectableList
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.SELECTABLE_LIST_SELECTOR)));
        ...
        public IList<IWebElement> SelectableGrid
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.SELECTABLE_GRID_SELECTOR)));
        ...
        public IList<IWebElement> SerializeList
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.SELECTABLE_SERIALIZIZE_SELECTOR)));
        ...
        public IWebElement SerializeResult
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.SELECT_RESULT_SELECTOR)));
