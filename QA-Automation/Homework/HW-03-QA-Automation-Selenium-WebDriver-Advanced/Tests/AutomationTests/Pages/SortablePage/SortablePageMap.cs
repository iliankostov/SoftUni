namespace AutomationTests.Pages.SortablePage
{
    ...
    public class SortablePageMap
    {
        ...
        public IWebElement ConnectListsTab
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.CONNECT_LISTS_TAB_SELECTOR)));
        ...
        public IList<IWebElement> SorableList
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.SORTABLE_LIST_SELECTOR)));
        ...
        public IList<IWebElement> ConnectListOne
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.CONNECT_LIST_ONE_SELECTOR)));
        ...
        public IList<IWebElement> ConnectListTwo
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.CONNECT_LIST_TWO_SELECTOR)));
        ...
        public IList<IWebElement> SorableGrid
        {
            get
            {
                this.wait.Until(ExpectedConditions.ElementExists(By.Id(Constants.SORTABLE_GRID_SELECTOR)));
